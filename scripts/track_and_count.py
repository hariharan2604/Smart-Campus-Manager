...
# Open the video file
cap = cv2.VideoCapture("samples/30952-383991415.mov")
...
output_filename = os.path.join(output_dir, f"instance-segmentation-object-tracking_{timestamp}.mp4")

# Initialize video writer to save the output video as MP4 using the 'mp4v' codec
out = cv2.VideoWriter(output_filename, cv2.VideoWriter_fourcc(*"mp4v"), fps, (w, h))
